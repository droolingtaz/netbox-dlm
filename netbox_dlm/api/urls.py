...
router.register("inventory-item-role-platforms", views.InventoryItemRolePlatformViewSet)
router.register("inventory-item-software", views.InventoryItemSoftwareViewSet)
